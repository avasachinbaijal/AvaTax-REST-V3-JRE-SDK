...
public class SystemApi {
     ...
     */
    public okhttp3.Call deleteSystemCall(String systemId, String avalaraVersion, String xCorrelationId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteSystemValidateBeforeCall(String systemId, String avalaraVersion, String xCorrelationId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteSystemCall(systemId, avalaraVersion, xCorrelationId, _callback);
        return localVarCall;
     ...
     */
    public void deleteSystem(String systemId, String avalaraVersion, String xCorrelationId) throws ApiException {
        deleteSystemWithHttpInfo(systemId, avalaraVersion, xCorrelationId);
    }
     ...
     */
    public ApiResponse<Void> deleteSystemWithHttpInfo(String systemId, String avalaraVersion, String xCorrelationId) throws ApiException {
        okhttp3.Call localVarCall = deleteSystemValidateBeforeCall(systemId, avalaraVersion, xCorrelationId, null);
     ...
     */
    public okhttp3.Call deleteSystemAsync(String systemId, String avalaraVersion, String xCorrelationId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteSystemValidateBeforeCall(systemId, avalaraVersion, xCorrelationId, _callback);
     ...
     */
    public okhttp3.Call getSystemCall(String systemId, String avalaraVersion, String xCorrelationId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSystemValidateBeforeCall(String systemId, String avalaraVersion, String xCorrelationId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getSystemCall(systemId, avalaraVersion, xCorrelationId, _callback);
        return localVarCall;
     ...
     */
    public System getSystem(String systemId, String avalaraVersion, String xCorrelationId) throws ApiException {
        ApiResponse<System> localVarResp = getSystemWithHttpInfo(systemId, avalaraVersion, xCorrelationId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<System> getSystemWithHttpInfo(String systemId, String avalaraVersion, String xCorrelationId) throws ApiException {
        okhttp3.Call localVarCall = getSystemValidateBeforeCall(systemId, avalaraVersion, xCorrelationId, null);
        Type localVarReturnType = new TypeToken<System>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getSystemAsync(String systemId, String avalaraVersion, String xCorrelationId, final ApiCallback<System> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSystemValidateBeforeCall(systemId, avalaraVersion, xCorrelationId, _callback);
        Type localVarReturnType = new TypeToken<System>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * Retrieve a list of all features associated with the system and which the authenticated user has access to. This list is paged, returning no more than 1000 items at a time.
     * @param systemId  (required)
     * @param $filter A filter statement to identify specific records to retrieve. (optional)
     * @param $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     * @param $skip If nonzero, skip this number of results before returning data.  Used with &#x60;$top&#x60; to provide pagination for large datasets. (optional)
     ...
     * Retrieve a list of all grants associated with the selected system and which the authenticated user has access to. This list is paged, returning no more than 1000 items at a time.
     * @param systemId  (required)
     * @param $filter A filter statement to identify specific records to retrieve. (optional)
     * @param $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     * @param $skip If nonzero, skip this number of results before returning data.  Used with &#x60;$top&#x60; to provide pagination for large datasets. (optional)
     ...
     * Retrieve a list of all features associated with the selected system and which the authenticated user has access to. This list is paged, returning no more than 1000 items at a time.
     * @param systemId  (required)
     * @param $filter A filter statement to identify specific records to retrieve. (optional)
     * @param $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     * @param $skip If nonzero, skip this number of results before returning data.  Used with &#x60;$top&#x60; to provide pagination for large datasets. (optional)
     ...
     * Retrieve a list of all roles associated with the selected system and which the authenticated user has access to. This list is paged, returning no more than 1000 items at a time.
     * @param systemId  (required)
     * @param $filter A filter statement to identify specific records to retrieve. (optional)
     * @param $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     * @param $skip If nonzero, skip this number of results before returning data.  Used with &#x60;$top&#x60; to provide pagination for large datasets. (optional)
     ...
     * Retrieve a list of all systems the authenticated user has access to. This list is paged, returning no more than 1000 items at a time.
     * @param $filter A filter statement to identify specific records to retrieve. (optional)
     * @param $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     * @param $skip If nonzero, skip this number of results before returning data.  Used with &#x60;$top&#x60; to provide pagination for large datasets. (optional)
     * @param $orderBy A comma separated list of sort statements in the format &#x60;(fieldname) [ASC|DESC]&#x60;, for example &#x60;id ASC&#x60;. (optional)
     ...
     */
    public okhttp3.Call patchSystemCall(String systemId, String avalaraVersion, String xCorrelationId, System system, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchSystemValidateBeforeCall(String systemId, String avalaraVersion, String xCorrelationId, System system, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchSystemCall(systemId, avalaraVersion, xCorrelationId, system, _callback);
        return localVarCall;
     ...
     */
    public void patchSystem(String systemId, String avalaraVersion, String xCorrelationId, System system) throws ApiException {
        patchSystemWithHttpInfo(systemId, avalaraVersion, xCorrelationId, system);
    }
     ...
     */
    public ApiResponse<Void> patchSystemWithHttpInfo(String systemId, String avalaraVersion, String xCorrelationId, System system) throws ApiException {
        okhttp3.Call localVarCall = patchSystemValidateBeforeCall(systemId, avalaraVersion, xCorrelationId, system, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call patchSystemAsync(String systemId, String avalaraVersion, String xCorrelationId, System system, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = patchSystemValidateBeforeCall(systemId, avalaraVersion, xCorrelationId, system, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     ...
     */
    public okhttp3.Call replaceSystemCall(String systemId, String avalaraVersion, String xCorrelationId, System system, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call replaceSystemValidateBeforeCall(String systemId, String avalaraVersion, String xCorrelationId, System system, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = replaceSystemCall(systemId, avalaraVersion, xCorrelationId, system, _callback);
        return localVarCall;
     ...
     */
    public void replaceSystem(String systemId, String avalaraVersion, String xCorrelationId, System system) throws ApiException {
        replaceSystemWithHttpInfo(systemId, avalaraVersion, xCorrelationId, system);
    }
     ...
     */
    public ApiResponse<Void> replaceSystemWithHttpInfo(String systemId, String avalaraVersion, String xCorrelationId, System system) throws ApiException {
        okhttp3.Call localVarCall = replaceSystemValidateBeforeCall(systemId, avalaraVersion, xCorrelationId, system, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call replaceSystemAsync(String systemId, String avalaraVersion, String xCorrelationId, System system, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = replaceSystemValidateBeforeCall(systemId, avalaraVersion, xCorrelationId, system, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
