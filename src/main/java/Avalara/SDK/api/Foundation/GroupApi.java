...
import Avalara.SDK.model.Foundation.Group;
...
public class GroupApi {
     ...
     */
    public okhttp3.Call deleteGroupCall(String groupId, String avalaraVersion, String xCorrelationId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteGroupValidateBeforeCall(String groupId, String avalaraVersion, String xCorrelationId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteGroupCall(groupId, avalaraVersion, xCorrelationId, _callback);
        return localVarCall;
     ...
     */
    public void deleteGroup(String groupId, String avalaraVersion, String xCorrelationId) throws ApiException {
        deleteGroupWithHttpInfo(groupId, avalaraVersion, xCorrelationId);
    }
     ...
     */
    public ApiResponse<Void> deleteGroupWithHttpInfo(String groupId, String avalaraVersion, String xCorrelationId) throws ApiException {
        okhttp3.Call localVarCall = deleteGroupValidateBeforeCall(groupId, avalaraVersion, xCorrelationId, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call deleteGroupAsync(String groupId, String avalaraVersion, String xCorrelationId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteGroupValidateBeforeCall(groupId, avalaraVersion, xCorrelationId, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     ...
     */
    public okhttp3.Call getGroupCall(String groupId, String avalaraVersion, String xCorrelationId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getGroupValidateBeforeCall(String groupId, String avalaraVersion, String xCorrelationId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getGroupCall(groupId, avalaraVersion, xCorrelationId, _callback);
        return localVarCall;
     ...
     */
    public Group getGroup(String groupId, String avalaraVersion, String xCorrelationId) throws ApiException {
        ApiResponse<Group> localVarResp = getGroupWithHttpInfo(groupId, avalaraVersion, xCorrelationId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Group> getGroupWithHttpInfo(String groupId, String avalaraVersion, String xCorrelationId) throws ApiException {
        okhttp3.Call localVarCall = getGroupValidateBeforeCall(groupId, avalaraVersion, xCorrelationId, null);
        Type localVarReturnType = new TypeToken<Group>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getGroupAsync(String groupId, String avalaraVersion, String xCorrelationId, final ApiCallback<Group> _callback) throws ApiException {

        okhttp3.Call localVarCall = getGroupValidateBeforeCall(groupId, avalaraVersion, xCorrelationId, _callback);
        Type localVarReturnType = new TypeToken<Group>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * Retrieve a list of all devices within a group which the authenticated user has access to. This list is paged, returning no more than 1000 items at a time.
     * @param groupId  (required)
     * @param $filter A filter statement to identify specific records to retrieve. (optional)
     * @param $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     * @param $skip If nonzero, skip this number of results before returning data.  Used with &#x60;$top&#x60; to provide pagination for large datasets. (optional)
     ...
     * Retrieve a list of all grants within a group which the authenticated user has access to. This list is paged, returning no more than 1000 items at a time.
     * @param groupId  (required)
     * @param $filter A filter statement to identify specific records to retrieve. (optional)
     * @param $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     * @param $skip If nonzero, skip this number of results before returning data.  Used with &#x60;$top&#x60; to provide pagination for large datasets. (optional)
     ...
     * Retrieve a list of all users within a group which the authenticated user has access to. This list is paged, returning no more than 1000 items at a time.
     * @param groupId  (required)
     * @param $filter A filter statement to identify specific records to retrieve. (optional)
     * @param $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     * @param $skip If nonzero, skip this number of results before returning data.  Used with &#x60;$top&#x60; to provide pagination for large datasets. (optional)
    ...
    /**
     * Get all groups.
     * Retrieve a list of all groups the authenticated user has access to. This list is paged, returning no more than 1000 items at a time.
     * @param $filter A filter statement to identify specific records to retrieve. (optional)
     * @param $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     * @param $skip If nonzero, skip this number of results before returning data.  Used with &#x60;$top&#x60; to provide pagination for large datasets. (optional)
     * @param count If set to &#39;true&#39;, requests the count of items as part of the response. Default: &#39;false&#39;. If the value cannot be (optional)
     ...
     */
    public okhttp3.Call patchGroupCall(String groupId, String avalaraVersion, String xCorrelationId, Group group, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchGroupValidateBeforeCall(String groupId, String avalaraVersion, String xCorrelationId, Group group, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchGroupCall(groupId, avalaraVersion, xCorrelationId, group, _callback);
        return localVarCall;
     ...
     */
    public void patchGroup(String groupId, String avalaraVersion, String xCorrelationId, Group group) throws ApiException {
        patchGroupWithHttpInfo(groupId, avalaraVersion, xCorrelationId, group);
    }
     ...
     */
    public ApiResponse<Void> patchGroupWithHttpInfo(String groupId, String avalaraVersion, String xCorrelationId, Group group) throws ApiException {
        okhttp3.Call localVarCall = patchGroupValidateBeforeCall(groupId, avalaraVersion, xCorrelationId, group, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call patchGroupAsync(String groupId, String avalaraVersion, String xCorrelationId, Group group, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = patchGroupValidateBeforeCall(groupId, avalaraVersion, xCorrelationId, group, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     ...
     */
    public okhttp3.Call replaceGroupCall(String groupId, String avalaraVersion, String xCorrelationId, Group group, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call replaceGroupValidateBeforeCall(String groupId, String avalaraVersion, String xCorrelationId, Group group, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = replaceGroupCall(groupId, avalaraVersion, xCorrelationId, group, _callback);
        return localVarCall;
     ...
     */
    public void replaceGroup(String groupId, String avalaraVersion, String xCorrelationId, Group group) throws ApiException {
        replaceGroupWithHttpInfo(groupId, avalaraVersion, xCorrelationId, group);
    }
     ...
     */
    public ApiResponse<Void> replaceGroupWithHttpInfo(String groupId, String avalaraVersion, String xCorrelationId, Group group) throws ApiException {
        okhttp3.Call localVarCall = replaceGroupValidateBeforeCall(groupId, avalaraVersion, xCorrelationId, group, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call replaceGroupAsync(String groupId, String avalaraVersion, String xCorrelationId, Group group, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = replaceGroupValidateBeforeCall(groupId, avalaraVersion, xCorrelationId, group, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
