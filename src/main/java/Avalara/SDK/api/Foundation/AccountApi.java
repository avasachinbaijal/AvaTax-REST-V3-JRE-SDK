...
public class AccountApi {
     ...
     */
    public okhttp3.Call deleteAccountCall(String accountId, String avalaraVersion, String xCorrelationId, String ifMatch, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteAccountValidateBeforeCall(String accountId, String avalaraVersion, String xCorrelationId, String ifMatch, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteAccountCall(accountId, avalaraVersion, xCorrelationId, ifMatch, _callback);
        return localVarCall;
     ...
     */
    public void deleteAccount(String accountId, String avalaraVersion, String xCorrelationId, String ifMatch) throws ApiException {
        deleteAccountWithHttpInfo(accountId, avalaraVersion, xCorrelationId, ifMatch);
    }
     ...
     */
    public ApiResponse<Void> deleteAccountWithHttpInfo(String accountId, String avalaraVersion, String xCorrelationId, String ifMatch) throws ApiException {
        okhttp3.Call localVarCall = deleteAccountValidateBeforeCall(accountId, avalaraVersion, xCorrelationId, ifMatch, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call deleteAccountAsync(String accountId, String avalaraVersion, String xCorrelationId, String ifMatch, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteAccountValidateBeforeCall(accountId, avalaraVersion, xCorrelationId, ifMatch, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     ...
     */
    public okhttp3.Call getAccountCall(String accountId, String avalaraVersion, String xCorrelationId, String ifNoneMatch, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAccountValidateBeforeCall(String accountId, String avalaraVersion, String xCorrelationId, String ifNoneMatch, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAccountCall(accountId, avalaraVersion, xCorrelationId, ifNoneMatch, _callback);
        return localVarCall;
     ...
     */
    public Account getAccount(String accountId, String avalaraVersion, String xCorrelationId, String ifNoneMatch) throws ApiException {
        ApiResponse<Account> localVarResp = getAccountWithHttpInfo(accountId, avalaraVersion, xCorrelationId, ifNoneMatch);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Account> getAccountWithHttpInfo(String accountId, String avalaraVersion, String xCorrelationId, String ifNoneMatch) throws ApiException {
        okhttp3.Call localVarCall = getAccountValidateBeforeCall(accountId, avalaraVersion, xCorrelationId, ifNoneMatch, null);
        Type localVarReturnType = new TypeToken<Account>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getAccountAsync(String accountId, String avalaraVersion, String xCorrelationId, String ifNoneMatch, final ApiCallback<Account> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAccountValidateBeforeCall(accountId, avalaraVersion, xCorrelationId, ifNoneMatch, _callback);
        Type localVarReturnType = new TypeToken<Account>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * Retrieve a list of all devices within an account which the authenticated user has access to. This list is paged, returning no more than 1000 items at a time.  Filterable properties:   * displayName * grants/identifier * active * groups/identifier
     * @param accountId  (required)
     * @param $filter A filter statement to identify specific records to retrieve. (optional)
     * @param $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     * @param $skip If nonzero, skip this number of results before returning data.  Used with &#x60;$top&#x60; to provide pagination for large datasets. (optional)
     ...
     * Retrieve a list of all entitlements on the account. This list is paged, returning no more than 1000 items at a time.  Filterable properties:   * displayName * system/identifier * active * features/identifier * customGrants/identifier
     * @param accountId  (required)
     * @param $filter A filter statement to identify specific records to retrieve. (optional)
     * @param $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     * @param $skip If nonzero, skip this number of results before returning data.  Used with &#x60;$top&#x60; to provide pagination for large datasets. (optional)
     ...
     * Retrieve a list of all groups on the account. This list is paged, returning no more than 1000 items at a time.  Filterable properties:   * displayName * grants/identifier
     * @param accountId  (required)
     * @param $filter A filter statement to identify specific records to retrieve. (optional)
     * @param $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     * @param $skip If nonzero, skip this number of results before returning data.  Used with &#x60;$top&#x60; to provide pagination for large datasets. (optional)
    ...
    /**
     * Add a grant to a user within an account.
     * Retrieve a list of all grants a user belongs to within the account which the authenticated user has access to. This list is paged, returning no more than 1000 items at a time.  Filterable properties:   * displayName * grants/identifier
     * @param accountId  (required)
     * @param userId  (required)
     * @param $filter A filter statement to identify specific records to retrieve. (optional)
     * @param $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     ...
     * Retrieve a list of all users within the account which the authenticated user has access to. This list is paged, returning no more than 1000 items at a time.  Filterable properties:   * displayName * emails/value * active * userName * grants/identifier * groups/identifier
     * @param accountId  (required)
     * @param $filter A filter statement to identify specific records to retrieve. (optional)
     * @param $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     * @param $skip If nonzero, skip this number of results before returning data.  Used with &#x60;$top&#x60; to provide pagination for large datasets. (optional)
     ...
     * Retrieve a list of all accounts the authenticated user has access to. This list is paged, returning no more than 1000 items at a time.  Filterable properties:   * displayName * organization/identifier
     * @param $filter A filter statement to identify specific records to retrieve. (optional)
     * @param $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     * @param $skip If nonzero, skip this number of results before returning data.  Used with &#x60;$top&#x60; to provide pagination for large datasets. (optional)
     * @param count If set to &#39;true&#39;, requests the count of items as part of the response. Default: &#39;false&#39;. If the value cannot be (optional)
     ...
     */
    public okhttp3.Call patchAccountCall(String accountId, String avalaraVersion, String xCorrelationId, String ifMatch, Account account, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchAccountValidateBeforeCall(String accountId, String avalaraVersion, String xCorrelationId, String ifMatch, Account account, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchAccountCall(accountId, avalaraVersion, xCorrelationId, ifMatch, account, _callback);
        return localVarCall;
     ...
     */
    public void patchAccount(String accountId, String avalaraVersion, String xCorrelationId, String ifMatch, Account account) throws ApiException {
        patchAccountWithHttpInfo(accountId, avalaraVersion, xCorrelationId, ifMatch, account);
    }
     ...
     */
    public ApiResponse<Void> patchAccountWithHttpInfo(String accountId, String avalaraVersion, String xCorrelationId, String ifMatch, Account account) throws ApiException {
        okhttp3.Call localVarCall = patchAccountValidateBeforeCall(accountId, avalaraVersion, xCorrelationId, ifMatch, account, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call patchAccountAsync(String accountId, String avalaraVersion, String xCorrelationId, String ifMatch, Account account, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = patchAccountValidateBeforeCall(accountId, avalaraVersion, xCorrelationId, ifMatch, account, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     ...
     */
    public okhttp3.Call replaceAccountCall(String accountId, String avalaraVersion, String xCorrelationId, String ifMatch, Account account, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call replaceAccountValidateBeforeCall(String accountId, String avalaraVersion, String xCorrelationId, String ifMatch, Account account, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = replaceAccountCall(accountId, avalaraVersion, xCorrelationId, ifMatch, account, _callback);
        return localVarCall;
     ...
     */
    public void replaceAccount(String accountId, String avalaraVersion, String xCorrelationId, String ifMatch, Account account) throws ApiException {
        replaceAccountWithHttpInfo(accountId, avalaraVersion, xCorrelationId, ifMatch, account);
    }
     ...
     */
    public ApiResponse<Void> replaceAccountWithHttpInfo(String accountId, String avalaraVersion, String xCorrelationId, String ifMatch, Account account) throws ApiException {
        okhttp3.Call localVarCall = replaceAccountValidateBeforeCall(accountId, avalaraVersion, xCorrelationId, ifMatch, account, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call replaceAccountAsync(String accountId, String avalaraVersion, String xCorrelationId, String ifMatch, Account account, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = replaceAccountValidateBeforeCall(accountId, avalaraVersion, xCorrelationId, ifMatch, account, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
