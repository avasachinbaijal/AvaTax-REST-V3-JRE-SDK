...
public class RoleApi {
     ...
     */
    public okhttp3.Call deleteRoleCall(String roleId, String avalaraVersion, String xCorrelationId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteRoleValidateBeforeCall(String roleId, String avalaraVersion, String xCorrelationId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteRoleCall(roleId, avalaraVersion, xCorrelationId, _callback);
        return localVarCall;
     ...
     */
    public void deleteRole(String roleId, String avalaraVersion, String xCorrelationId) throws ApiException {
        deleteRoleWithHttpInfo(roleId, avalaraVersion, xCorrelationId);
    }
     ...
     */
    public ApiResponse<Void> deleteRoleWithHttpInfo(String roleId, String avalaraVersion, String xCorrelationId) throws ApiException {
        okhttp3.Call localVarCall = deleteRoleValidateBeforeCall(roleId, avalaraVersion, xCorrelationId, null);
     ...
     */
    public okhttp3.Call deleteRoleAsync(String roleId, String avalaraVersion, String xCorrelationId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteRoleValidateBeforeCall(roleId, avalaraVersion, xCorrelationId, _callback);
     ...
     */
    public okhttp3.Call getRoleCall(String roleId, String avalaraVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getRoleValidateBeforeCall(String roleId, String avalaraVersion, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getRoleCall(roleId, avalaraVersion, _callback);
        return localVarCall;
     ...
     */
    public Role getRole(String roleId, String avalaraVersion) throws ApiException {
        ApiResponse<Role> localVarResp = getRoleWithHttpInfo(roleId, avalaraVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Role> getRoleWithHttpInfo(String roleId, String avalaraVersion) throws ApiException {
        okhttp3.Call localVarCall = getRoleValidateBeforeCall(roleId, avalaraVersion, null);
        Type localVarReturnType = new TypeToken<Role>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getRoleAsync(String roleId, String avalaraVersion, final ApiCallback<Role> _callback) throws ApiException {

        okhttp3.Call localVarCall = getRoleValidateBeforeCall(roleId, avalaraVersion, _callback);
        Type localVarReturnType = new TypeToken<Role>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * Retrieve a list of all roles the authenticated user has access to. This list is paged, returning no more than 1000 items at a time.
     * @param $filter A filter statement to identify specific records to retrieve. (optional)
     * @param $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     * @param $skip If nonzero, skip this number of results before returning data.  Used with &#x60;$top&#x60; to provide pagination for large datasets. (optional)
     * @param $orderBy A comma separated list of sort statements in the format &#x60;(fieldname) [ASC|DESC]&#x60;, for example &#x60;id ASC&#x60;. (optional)
     ...
     */
    public okhttp3.Call patchRoleCall(String roleId, String avalaraVersion, String xCorrelationId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchRoleValidateBeforeCall(String roleId, String avalaraVersion, String xCorrelationId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchRoleCall(roleId, avalaraVersion, xCorrelationId, _callback);
        return localVarCall;
     ...
     */
    public void patchRole(String roleId, String avalaraVersion, String xCorrelationId) throws ApiException {
        patchRoleWithHttpInfo(roleId, avalaraVersion, xCorrelationId);
    }
     ...
     */
    public ApiResponse<Void> patchRoleWithHttpInfo(String roleId, String avalaraVersion, String xCorrelationId) throws ApiException {
        okhttp3.Call localVarCall = patchRoleValidateBeforeCall(roleId, avalaraVersion, xCorrelationId, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call patchRoleAsync(String roleId, String avalaraVersion, String xCorrelationId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = patchRoleValidateBeforeCall(roleId, avalaraVersion, xCorrelationId, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     ...
     */
    public okhttp3.Call replaceRoleCall(String roleId, String avalaraVersion, String xCorrelationId, Role role, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call replaceRoleValidateBeforeCall(String roleId, String avalaraVersion, String xCorrelationId, Role role, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = replaceRoleCall(roleId, avalaraVersion, xCorrelationId, role, _callback);
        return localVarCall;
     ...
     */
    public void replaceRole(String roleId, String avalaraVersion, String xCorrelationId, Role role) throws ApiException {
        replaceRoleWithHttpInfo(roleId, avalaraVersion, xCorrelationId, role);
    }
     ...
     */
    public ApiResponse<Void> replaceRoleWithHttpInfo(String roleId, String avalaraVersion, String xCorrelationId, Role role) throws ApiException {
        okhttp3.Call localVarCall = replaceRoleValidateBeforeCall(roleId, avalaraVersion, xCorrelationId, role, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call replaceRoleAsync(String roleId, String avalaraVersion, String xCorrelationId, Role role, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = replaceRoleValidateBeforeCall(roleId, avalaraVersion, xCorrelationId, role, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
