...
import Avalara.SDK.model.Foundation.Grant;
...
public class GrantApi {
     ...
     */
    public okhttp3.Call deleteGrantCall(String grantId, String avalaraVersion, String xCorrelationId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteGrantValidateBeforeCall(String grantId, String avalaraVersion, String xCorrelationId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteGrantCall(grantId, avalaraVersion, xCorrelationId, _callback);
        return localVarCall;
     ...
     */
    public void deleteGrant(String grantId, String avalaraVersion, String xCorrelationId) throws ApiException {
        deleteGrantWithHttpInfo(grantId, avalaraVersion, xCorrelationId);
    }
     ...
     */
    public ApiResponse<Void> deleteGrantWithHttpInfo(String grantId, String avalaraVersion, String xCorrelationId) throws ApiException {
        okhttp3.Call localVarCall = deleteGrantValidateBeforeCall(grantId, avalaraVersion, xCorrelationId, null);
     ...
     */
    public okhttp3.Call deleteGrantAsync(String grantId, String avalaraVersion, String xCorrelationId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteGrantValidateBeforeCall(grantId, avalaraVersion, xCorrelationId, _callback);
     ...
     */
    public okhttp3.Call getGrantCall(String grantId, String avalaraVersion, String xCorrelationId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getGrantValidateBeforeCall(String grantId, String avalaraVersion, String xCorrelationId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getGrantCall(grantId, avalaraVersion, xCorrelationId, _callback);
        return localVarCall;
     ...
     */
    public Grant getGrant(String grantId, String avalaraVersion, String xCorrelationId) throws ApiException {
        ApiResponse<Grant> localVarResp = getGrantWithHttpInfo(grantId, avalaraVersion, xCorrelationId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Grant> getGrantWithHttpInfo(String grantId, String avalaraVersion, String xCorrelationId) throws ApiException {
        okhttp3.Call localVarCall = getGrantValidateBeforeCall(grantId, avalaraVersion, xCorrelationId, null);
        Type localVarReturnType = new TypeToken<Grant>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getGrantAsync(String grantId, String avalaraVersion, String xCorrelationId, final ApiCallback<Grant> _callback) throws ApiException {

        okhttp3.Call localVarCall = getGrantValidateBeforeCall(grantId, avalaraVersion, xCorrelationId, _callback);
        Type localVarReturnType = new TypeToken<Grant>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * Retrieve a list of all grants the authenticated user has access to. This list is paged, returning no more than 1000 items at a time.
     * @param $filter A filter statement to identify specific records to retrieve. (optional)
     * @param $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     * @param $skip If nonzero, skip this number of results before returning data.  Used with &#x60;$top&#x60; to provide pagination for large datasets. (optional)
     * @param $orderBy A comma separated list of sort statements in the format &#x60;(fieldname) [ASC|DESC]&#x60;, for example &#x60;id ASC&#x60;. (optional)
     ...
     */
    public okhttp3.Call patchGrantCall(String grantId, String avalaraVersion, String xCorrelationId, Grant grant, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchGrantValidateBeforeCall(String grantId, String avalaraVersion, String xCorrelationId, Grant grant, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchGrantCall(grantId, avalaraVersion, xCorrelationId, grant, _callback);
        return localVarCall;
     ...
     */
    public void patchGrant(String grantId, String avalaraVersion, String xCorrelationId, Grant grant) throws ApiException {
        patchGrantWithHttpInfo(grantId, avalaraVersion, xCorrelationId, grant);
    }
     ...
     */
    public ApiResponse<Void> patchGrantWithHttpInfo(String grantId, String avalaraVersion, String xCorrelationId, Grant grant) throws ApiException {
        okhttp3.Call localVarCall = patchGrantValidateBeforeCall(grantId, avalaraVersion, xCorrelationId, grant, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call patchGrantAsync(String grantId, String avalaraVersion, String xCorrelationId, Grant grant, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = patchGrantValidateBeforeCall(grantId, avalaraVersion, xCorrelationId, grant, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     ...
     */
    public okhttp3.Call replaceGrantCall(String grantId, String avalaraVersion, String xCorrelationId, Grant grant, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call replaceGrantValidateBeforeCall(String grantId, String avalaraVersion, String xCorrelationId, Grant grant, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = replaceGrantCall(grantId, avalaraVersion, xCorrelationId, grant, _callback);
        return localVarCall;
     ...
     */
    public void replaceGrant(String grantId, String avalaraVersion, String xCorrelationId, Grant grant) throws ApiException {
        replaceGrantWithHttpInfo(grantId, avalaraVersion, xCorrelationId, grant);
    }
     ...
     */
    public ApiResponse<Void> replaceGrantWithHttpInfo(String grantId, String avalaraVersion, String xCorrelationId, Grant grant) throws ApiException {
        okhttp3.Call localVarCall = replaceGrantValidateBeforeCall(grantId, avalaraVersion, xCorrelationId, grant, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call replaceGrantAsync(String grantId, String avalaraVersion, String xCorrelationId, Grant grant, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = replaceGrantValidateBeforeCall(grantId, avalaraVersion, xCorrelationId, grant, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
