...
import Avalara.SDK.model.Foundation.Organization;
import Avalara.SDK.model.Foundation.OrganizationList;
...
public class OrganizationApi {
    ...
    /**
     * Build call for listOrganizationAccounts
     ...
     */
    public okhttp3.Call listOrganizationAccountsCall(String organizationId, String $filter, String $top, String $skip, String $orderBy, Boolean count, Boolean countOnly, String avalaraVersion, String xCorrelationId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/organizations/{organization-id}/accounts"
            .replaceAll("\\{" + "organization-id" + "\\}", localVarApiClient.escapeString(organizationId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listOrganizationAccountsValidateBeforeCall(String organizationId, String $filter, String $top, String $skip, String $orderBy, Boolean count, Boolean countOnly, String avalaraVersion, String xCorrelationId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'organizationId' is set
        if (organizationId == null) {
            throw new ApiException("Missing the required parameter 'organizationId' when calling listOrganizationAccounts(Async)");
        }
        

        okhttp3.Call localVarCall = listOrganizationAccountsCall(organizationId, $filter, $top, $skip, $orderBy, count, countOnly, avalaraVersion, xCorrelationId, _callback);
        return localVarCall;

    }

    /**
     * Get all accounts within an organization.
     * Retrieve a list of all accounts within the organization which the authenticated user has access to. This list is paged, returning no more than 1000 items at a time.  Filterable properties:   * displayName
     * @param organizationId  (required)
     * @param $filter A filter statement to identify specific records to retrieve. (optional)
     * @param $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     * @param $skip If nonzero, skip this number of results before returning data.  Used with &#x60;$top&#x60; to provide pagination for large datasets. (optional)
     ...
     */
    public AccountList listOrganizationAccounts(String organizationId, String $filter, String $top, String $skip, String $orderBy, Boolean count, Boolean countOnly, String avalaraVersion, String xCorrelationId) throws ApiException {
        ApiResponse<AccountList> localVarResp = listOrganizationAccountsWithHttpInfo(organizationId, $filter, $top, $skip, $orderBy, count, countOnly, avalaraVersion, xCorrelationId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AccountList> listOrganizationAccountsWithHttpInfo(String organizationId, String $filter, String $top, String $skip, String $orderBy, Boolean count, Boolean countOnly, String avalaraVersion, String xCorrelationId) throws ApiException {
        okhttp3.Call localVarCall = listOrganizationAccountsValidateBeforeCall(organizationId, $filter, $top, $skip, $orderBy, count, countOnly, avalaraVersion, xCorrelationId, null);
        Type localVarReturnType = new TypeToken<AccountList>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get all accounts within an organization. (asynchronously)
     * Retrieve a list of all accounts within the organization which the authenticated user has access to. This list is paged, returning no more than 1000 items at a time.  Filterable properties:   * displayName
     * @param organizationId  (required)
     * @param $filter A filter statement to identify specific records to retrieve. (optional)
     * @param $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     ...
     */
    public okhttp3.Call listOrganizationAccountsAsync(String organizationId, String $filter, String $top, String $skip, String $orderBy, Boolean count, Boolean countOnly, String avalaraVersion, String xCorrelationId, final ApiCallback<AccountList> _callback) throws ApiException {

        okhttp3.Call localVarCall = listOrganizationAccountsValidateBeforeCall(organizationId, $filter, $top, $skip, $orderBy, count, countOnly, avalaraVersion, xCorrelationId, _callback);
        Type localVarReturnType = new TypeToken<AccountList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * Retrieves a list of applications associated with an organization.  Filterable properties:   * displayName * type * accounts/identifier * grants/identifier
     * @param organizationId  (required)
     * @param $filter A filter statement to identify specific records to retrieve. (optional)
     * @param $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     * @param $skip If nonzero, skip this number of results before returning data.  Used with &#x60;$top&#x60; to provide pagination for large datasets. (optional)
