...
public class OrganizationApi {
     ...
     */
    public okhttp3.Call deleteOrganizationCall(String organizationId, String avalaraVersion, String xCorrelationId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteOrganizationValidateBeforeCall(String organizationId, String avalaraVersion, String xCorrelationId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteOrganizationCall(organizationId, avalaraVersion, xCorrelationId, _callback);
        return localVarCall;
     ...
     */
    public void deleteOrganization(String organizationId, String avalaraVersion, String xCorrelationId) throws ApiException {
        deleteOrganizationWithHttpInfo(organizationId, avalaraVersion, xCorrelationId);
    }
     ...
     */
    public ApiResponse<Void> deleteOrganizationWithHttpInfo(String organizationId, String avalaraVersion, String xCorrelationId) throws ApiException {
        okhttp3.Call localVarCall = deleteOrganizationValidateBeforeCall(organizationId, avalaraVersion, xCorrelationId, null);
     ...
     */
    public okhttp3.Call deleteOrganizationAsync(String organizationId, String avalaraVersion, String xCorrelationId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteOrganizationValidateBeforeCall(organizationId, avalaraVersion, xCorrelationId, _callback);
     ...
     */
    public okhttp3.Call getOrganizationCall(String organizationId, String avalaraVersion, String xCorrelationId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getOrganizationValidateBeforeCall(String organizationId, String avalaraVersion, String xCorrelationId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getOrganizationCall(organizationId, avalaraVersion, xCorrelationId, _callback);
        return localVarCall;
     ...
     */
    public Organization getOrganization(String organizationId, String avalaraVersion, String xCorrelationId) throws ApiException {
        ApiResponse<Organization> localVarResp = getOrganizationWithHttpInfo(organizationId, avalaraVersion, xCorrelationId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Organization> getOrganizationWithHttpInfo(String organizationId, String avalaraVersion, String xCorrelationId) throws ApiException {
        okhttp3.Call localVarCall = getOrganizationValidateBeforeCall(organizationId, avalaraVersion, xCorrelationId, null);
        Type localVarReturnType = new TypeToken<Organization>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getOrganizationAsync(String organizationId, String avalaraVersion, String xCorrelationId, final ApiCallback<Organization> _callback) throws ApiException {

        okhttp3.Call localVarCall = getOrganizationValidateBeforeCall(organizationId, avalaraVersion, xCorrelationId, _callback);
        Type localVarReturnType = new TypeToken<Organization>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * Retrieve a list of all accounts within the organization which the authenticated user has access to. This list is paged, returning no more than 1000 items at a time.
     * @param organizationId  (required)
     * @param $filter A filter statement to identify specific records to retrieve. (optional)
     * @param $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     * @param $skip If nonzero, skip this number of results before returning data.  Used with &#x60;$top&#x60; to provide pagination for large datasets. (optional)
     ...
     * Retrieves a list of applications associated with an organization.
     * @param organizationId  (required)
     * @param $filter A filter statement to identify specific records to retrieve. (optional)
     * @param $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     * @param $skip If nonzero, skip this number of results before returning data.  Used with &#x60;$top&#x60; to provide pagination for large datasets. (optional)
     ...
     * Retrieve a list of all users within the organization which the authenticated user has access to. This list is paged, returning no more than 1000 items at a time.
     * @param organizationId  (required)
     * @param $filter A filter statement to identify specific records to retrieve. (optional)
     * @param $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     * @param $skip If nonzero, skip this number of results before returning data.  Used with &#x60;$top&#x60; to provide pagination for large datasets. (optional)
     ...
     * Retrieve a list of all organizations the authenticated user has access to. This list is paged, returning no more than 1000 items at a time.
     * @param $filter A filter statement to identify specific records to retrieve. (optional)
     * @param $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     * @param $skip If nonzero, skip this number of results before returning data.  Used with &#x60;$top&#x60; to provide pagination for large datasets. (optional)
     * @param $orderBy A comma separated list of sort statements in the format &#x60;(fieldname) [ASC|DESC]&#x60;, for example &#x60;id ASC&#x60;. (optional)
     ...
     */
    public okhttp3.Call patchOrganizationCall(String organizationId, String avalaraVersion, String xCorrelationId, Organization organization, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchOrganizationValidateBeforeCall(String organizationId, String avalaraVersion, String xCorrelationId, Organization organization, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchOrganizationCall(organizationId, avalaraVersion, xCorrelationId, organization, _callback);
        return localVarCall;
     ...
     */
    public void patchOrganization(String organizationId, String avalaraVersion, String xCorrelationId, Organization organization) throws ApiException {
        patchOrganizationWithHttpInfo(organizationId, avalaraVersion, xCorrelationId, organization);
    }
     ...
     */
    public ApiResponse<Void> patchOrganizationWithHttpInfo(String organizationId, String avalaraVersion, String xCorrelationId, Organization organization) throws ApiException {
        okhttp3.Call localVarCall = patchOrganizationValidateBeforeCall(organizationId, avalaraVersion, xCorrelationId, organization, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call patchOrganizationAsync(String organizationId, String avalaraVersion, String xCorrelationId, Organization organization, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = patchOrganizationValidateBeforeCall(organizationId, avalaraVersion, xCorrelationId, organization, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     ...
     */
    public okhttp3.Call replaceOrganizationCall(String organizationId, String avalaraVersion, String xCorrelationId, Organization organization, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call replaceOrganizationValidateBeforeCall(String organizationId, String avalaraVersion, String xCorrelationId, Organization organization, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = replaceOrganizationCall(organizationId, avalaraVersion, xCorrelationId, organization, _callback);
        return localVarCall;
     ...
     */
    public void replaceOrganization(String organizationId, String avalaraVersion, String xCorrelationId, Organization organization) throws ApiException {
        replaceOrganizationWithHttpInfo(organizationId, avalaraVersion, xCorrelationId, organization);
    }
     ...
     */
    public ApiResponse<Void> replaceOrganizationWithHttpInfo(String organizationId, String avalaraVersion, String xCorrelationId, Organization organization) throws ApiException {
        okhttp3.Call localVarCall = replaceOrganizationValidateBeforeCall(organizationId, avalaraVersion, xCorrelationId, organization, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call replaceOrganizationAsync(String organizationId, String avalaraVersion, String xCorrelationId, Organization organization, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = replaceOrganizationValidateBeforeCall(organizationId, avalaraVersion, xCorrelationId, organization, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
