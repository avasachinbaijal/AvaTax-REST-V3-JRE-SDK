...
/**
 * Representation of an Entitlement between an Account and a System
 */
@ApiModel(description = "Representation of an Entitlement between an Account and a System")
...
public class Entitlement {
  ...
  **/
  ...
  public Entitlement account(Reference account) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.displayName, entitlement.displayName) &&
        ...
        Objects.equals(this.account, entitlement.account) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(displayName, system, account, active, features, customGrants, id, meta, aspects, tags);
  }
