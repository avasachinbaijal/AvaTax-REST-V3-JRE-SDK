...
/**
 * An IAM Organization defines a logical context in which Users and Accounts are managed
 */
@ApiModel(description = "An IAM Organization defines a logical context in which Users and Accounts are managed")
...
public class Organization {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Human-readable name of the Organization")
  ...
  public Organization contacts(List<Object> contacts) {
    
    this.contacts = contacts;
    return this;
  }

  public Organization addContactsItem(Object contactsItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Organization contacts")
