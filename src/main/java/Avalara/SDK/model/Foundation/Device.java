...
public class Device {
  ...
  **/
  ...
  public Device account(Reference account) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.displayName, device.displayName) &&
        Objects.equals(this.account, device.account) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(displayName, account, identity, active, grants, groups, id, meta, aspects, tags);
  }
