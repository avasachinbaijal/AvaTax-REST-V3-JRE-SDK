...
public class EntitlementList {
  ...
  private List<Entitlement> items = null;


  public EntitlementList atRecordsetCount(Integer atRecordsetCount) {
  ...
  **/
  ...
  public EntitlementList atNextLink(String atNextLink) {
  ...
  **/
  ...
  public EntitlementList pageKey(String pageKey) {
  ...
  **/
  ...
  public EntitlementList items(List<Entitlement> items) {
    
    this.items = items;
    return this;
  }

  public EntitlementList addItemsItem(Entitlement itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<Entitlement>();
    }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EntitlementList entitlementList = (EntitlementList) o;
    return Objects.equals(this.atRecordsetCount, entitlementList.atRecordsetCount) &&
        Objects.equals(this.atNextLink, entitlementList.atNextLink) &&
        Objects.equals(this.pageKey, entitlementList.pageKey) &&
        Objects.equals(this.items, entitlementList.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class EntitlementList {\n");
