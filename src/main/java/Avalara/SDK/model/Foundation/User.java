...
public class User extends HashMap<String, Object> {
  ...
  private Reference defaultAccount;
  ...
  **/
  ...
  public User defaultAccount(Reference defaultAccount) {
  ...
  **/
  ...
  public Reference getDefaultAccount() {
    return defaultAccount;
  }


  public void setDefaultAccount(Reference defaultAccount) {
    this.defaultAccount = defaultAccount;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.externalId, user.externalId) &&
        ...
        Objects.equals(this.defaultAccount, user.defaultAccount) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(externalId, userName, organization, name, displayName, nickName, profileUrl, title, userType, preferredLanguage, locale, timezone, active, password, emails, phoneNumbers, addresses, defaultAccount, customClaims, id, meta, aspects, tags, super.hashCode());
  }
