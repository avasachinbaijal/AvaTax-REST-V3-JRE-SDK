...
public class User {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(externalId, userName, organization, name, displayName, nickName, profileUrl, title, userType, preferredLanguage, locale, timezone, active, password, emails, phoneNumbers, addresses, defaultAccount, customClaims, id, meta, aspects, tags);
  }
