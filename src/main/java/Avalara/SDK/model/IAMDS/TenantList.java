...
public class TenantList {
  ...
  private List<Tenant> items = null;


  public TenantList atRecordsetCount(Integer atRecordsetCount) {
  ...
  **/
  ...
  public TenantList atNextLink(String atNextLink) {
  ...
  **/
  ...
  public TenantList pageKey(String pageKey) {
  ...
  **/
  ...
  public TenantList items(List<Tenant> items) {
    
    this.items = items;
    return this;
  }

  public TenantList addItemsItem(Tenant itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<Tenant>();
    }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atRecordsetCount, tenantList.atRecordsetCount) &&
        Objects.equals(this.atNextLink, tenantList.atNextLink) &&
        Objects.equals(this.pageKey, tenantList.pageKey) &&
        Objects.equals(this.items, tenantList.items);
  }
