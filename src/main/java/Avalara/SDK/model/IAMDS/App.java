...
public class App {
  ...
  **/
  ...
  @ApiModelProperty(value = "Whether the App is allowed to access information across all Tenants within its Organization")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether the App is allowed to access information across all Organizations and Tenants")
  ...
  public App tenants(List<Object> tenants) {
    
    this.tenants = tenants;
    return this;
  }

  public App addTenantsItem(Object tenantsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.displayName, app.displayName) &&
        ...
        Objects.equals(this.tenants, app.tenants) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(displayName, type, organization, isTenantAgnostic, isOrgAgnostic, tenants, clientId, redirectUris, grants, id, meta, aspects, tags);
  }
